          ...
          <div className="yoga_main">
            ...
            <div className="main_right" style={{ marginTop: "100px" }}>
              ...
              <h3 style={{ fontSize: "25px" }}>
                <br></br>1. Grasp a bar above your head. You don't have to
                necessarily be hanging at this stage, but ideally, the grip does
                have to be well above your head. You can try an overhand grip
                with your thumb around the bar to improve stability
                <br></br>
                <br></br>2. Tilt your pelvis slightly backward. Engage your
                abdominals and hip flexors to lift your feet off the ground by
                raising your legs outward in front of you, keeping them
                straight. Exhale while lifting the legs. Feel the abdominal
                muscles working hard as you do this.
                <br></br>
                <br></br>3. Raise your legs to the level you are able to do with
                good form. Aim to raise them parallel to the ground (hip bent 90
                degrees) or a little higher.
                <br></br>
                <br></br>4. Slowly lower your legs back down to vertical,
                inhaling. Maintain the posterior pelvic tilt even at the bottom
                of the movement.
                <br></br>
              </h3>
            </div>
