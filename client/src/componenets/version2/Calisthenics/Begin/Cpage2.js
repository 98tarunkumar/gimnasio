        ...
        <div className="workoutmain">
          <div className="yoga_main">
            <div className="main_left" style={{ marginTop: "-60px" }}>
              <h1>Chinups</h1>
              <ReactPlayer
                url="https://www.youtube.com/watch?v=b-ztMQpj8yc"
                width="80%"
                height="60%"
            ...
            <div className="main_right" style={{ marginTop: "100px" }}>
              ...
              <h3 style={{ fontSize: "25px" }}>
                ...
                <br></br>
                <br></br>2.Grasp the bar from underneath with your arms in a
                tight, slightly closer than shoulder-width grip.
                <br></br>
                <br></br>3. Use your biceps to pull you up, bringing your head
                up over the bar.
                <br></br>
              </h3>
            </div>
